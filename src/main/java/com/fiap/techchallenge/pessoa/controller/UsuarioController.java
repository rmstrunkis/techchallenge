...
import com.fiap.techchallenge.pessoa.service.UsuarioService;
...
public class UsuarioController {
    ...
    public ResponseEntity<UsuarioDTO> save(@Valid @RequestBody UsuarioDTO dto) {
        ...
        URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand((usuario.getClass())).toUri();
